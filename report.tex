...
\begin{figure}[h]
  ...
  \caption{Decomposition of the integer hull of the polytope defined by the
           ...
           The boundary of the set $(Q + B)$ is represented
           in red and $(Q + B)_I$ is represented in green.}
\end{figure}
...
% TODO: this is incomplete and not very clear
%Moreover, we can choose a point that is a combination of a linearly independant
%family of vectors of $\{y_0, ..., y_{s-1}\}$ \footnote{using the fundamental
%theorem of linear inequalities}. In other words ...
...
%$$(Q + B) \cap \ints^n \neq \emptyset \Longleftrightarrow
%  (Q + B) \cap \llbracket -B, B \rrbracket ^ n \neq \emptyset
%$$
...
found, or $\mathtt{None}$ otherwise.
