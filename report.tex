...
\label{forbb}
%TODO: add a link to a repository containing the code

The next part is the formalization of a branch-and-bound algorithm, as described
in the section \ref{bbdescr}. The idea was to state and prove the correctness
of a simple algorithm, without any optimization for the moment.
...
% TODO: give a more precise line count
In total, the formalization of this algorithm takes around 1000 lines of code.
